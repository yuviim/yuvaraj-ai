...
export function ContentCard({ item }: ContentCardProps) {
  ...
  return React.createElement(
    ...
    React.createElement("div", {
      ...
      React.createElement("div", { style: { position: "absolute", inset: 0, opacity: 0.5, background: "radial-gradient(circle at 70% 65%, rgba(255,255,255,.08), transparent 55%)" } }),
    ...
    React.createElement("div", { style: { padding: "14px 16px 16px" } },
      ...
      item.readingTimeMin
        ? React.createElement("span", { style: { fontSize: "11px", color: "#9AA3B2" } }, item.readingTimeMin + " min read")
        : null
    )
  );
}
